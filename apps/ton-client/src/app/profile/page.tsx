// このファイルは、TON（Telegram）クライアントのプロフィール画面です。
    ...
    const fetchData = async () => {
      try {
        ...
        const dummyProfile: UserProfile = {
          id: '1',
          username: 'H1ro5',
          avatar: 'https://placehold.co/300x300/blue/white?text=H1ro5',
          level: 15,
          exp: 1500,
          nextLevelExp: 2000,
          joinDate: '2025-01-15',
          bio: 'TONクライアントのユーザーです。ゲームが大好きで、特にRPGとアドベンチャーゲームをよくプレイします。',
          stats: {
            questsCompleted: 42,
                ...
                <div className="flex justify-between items-center">
                  ...
                  {!isEditing && (
                    <button
                      ...
                      className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
                    >
                      編集
                    </button>
                  )}
