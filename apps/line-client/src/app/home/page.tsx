...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-900 to-black text-white pb-20">
      {/* キャラクターセクション */}
      {character && (
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center">
                    <div className="flex-1 bg-gray-700 rounded-full h-2.5 mr-2">
                      <div 
                        className={`h-2.5 rounded-full ${quest.completed ? 'bg-green-600' : 'bg-green-500'}`}
                ...
                <div className="ml-4 flex flex-col items-center">
                  ...
                  {!quest.completed && (
                    <button
                      ...
                      className="mt-2 bg-green-600 hover:bg-green-700 text-white text-xs py-1 px-2 rounded focus:outline-none focus:shadow-outline transition duration-300"
                    >
                      進める
                    </button>
                  )}
