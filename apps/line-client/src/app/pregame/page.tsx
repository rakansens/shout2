        ...
        <div className="p-4">
          ...
          >
            <CardHeader className="p-0 space-y-0">
              <div className="justify-between px-2.5 py-0 w-full bg-[#4dc24bcc] rounded-[14px_14px_0px_0px] overflow-hidden backdrop-blur-[10px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(10px)_brightness(100%)] flex items-center">
                ...
                <div className="inline-flex flex-col items-center justify-center pt-1 pb-0 px-0 relative">
                  ...
                  <div className="absolute h-[19px] top-3.5 left-3.2 [font-family:'Good_Times-Heavy',Helvetica] font-normal text-[#3c8a3b] text-base tracking-[0] leading-[normal] whitespace-nowrap">
                    {song.stars}
                  </div>
                </div>
              </div>
          ...
          <div className={`mb-6 ${isLoaded && animationsEnabled ? 'pregame-comments-animate-entry' : ''}`}>
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 mb-4">
              <textarea
                className="w-full bg-gray-700 text-white rounded-lg p-3 mb-2 min-h-[80px] focus:outline-none focus:ring-2 focus:ring-green-500"
                placeholder="コメントを入力..."
                value={newComment}
                  ...
                  <div key={comment.id} className="bg-gray-800/50 rounded-lg p-4">
                    <div className="flex items-center mb-2">
                      <Avatar className="w-8 h-8 mr-2">
                        <AvatarFallback className="bg-green-600">{comment.username.charAt(0).toUpperCase()}</AvatarFallback>
                      </Avatar>
                      <div>
          ...
          <div className="fixed bottom-20 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
            <Button
              className="w-full bg-green-600 hover:bg-green-700 text-white py-4 text-lg font-bold rounded-lg"
              onClick={handlePlay}
            >
              プレイする
            </Button>
