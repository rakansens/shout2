        ...
        const dummyRankings: RankingUser[] = [
          {
            id: '1',
            username: 'user1',
            avatar: 'https://placehold.co/100x100/green/white?text=U1',
            score: 9500,
            rank: 1,
            isCurrentUser: false
          },
          {
            id: '2',
            username: 'user2',
            avatar: 'https://placehold.co/100x100/green/white?text=U2',
            score: 8200,
            rank: 2,
            isCurrentUser: false
          },
          {
            id: '3',
            username: 'LINEユーザー', // 現在のユーザー
            avatar: 'https://placehold.co/100x100/green/white?text=You',
            score: 7800,
            rank: 3,
            isCurrentUser: true
          },
          {
            id: '4',
            username: 'user4',
            avatar: 'https://placehold.co/100x100/green/white?text=U4',
            score: 7500,
            rank: 4,
            isCurrentUser: false
          },
          {
            id: '5',
            username: 'user5',
            avatar: 'https://placehold.co/100x100/green/white?text=U5',
            score: 7200,
            rank: 5,
            isCurrentUser: false
          },
          {
            id: '6',
            username: 'user6',
            avatar: 'https://placehold.co/100x100/green/white?text=U6',
            score: 6800,
            rank: 6,
            isCurrentUser: false
          },
          {
            id: '7',
            username: 'user7',
            avatar: 'https://placehold.co/100x100/green/white?text=U7',
            score: 6500,
            rank: 7,
            isCurrentUser: false
          },
          {
            id: '8',
            username: 'user8',
            avatar: 'https://placehold.co/100x100/green/white?text=U8',
            score: 6200,
            rank: 8,
            isCurrentUser: false
          },
          {
            id: '9',
            username: 'user9',
            avatar: 'https://placehold.co/100x100/green/white?text=U9',
            score: 5900,
            rank: 9,
            isCurrentUser: false
          },
          {
            id: '10',
            username: 'user10',
            avatar: 'https://placehold.co/100x100/green/white?text=U10',
            score: 5600,
            rank: 10,
            isCurrentUser: false
          }
          ...
          <div className={`bg-gray-800/50 rounded-lg overflow-hidden ${isLoaded && animationsEnabled ? 'rankings-section-animate-entry delay-1' : ''}`}>
            ...
            <ul className="divide-y divide-gray-700">
              {rankings.map((user, index) => (
                <li 
                  key={user.id}
                  className={`px-4 py-3 ${user.isCurrentUser ? 'bg-green-900/30' : ''} ${isLoaded && animationsEnabled ? `animate-entry delay-${index + 2}` : ''}`}
                  ...
                  <div className="grid grid-cols-12 gap-2 items-center">
                    ...
                    <div className="col-span-6 flex items-center">
                      ...
                      <div className="font-medium">
                        {user.username}
                        {user.isCurrentUser && (
                          <span className="ml-2 px-2 py-0.5 text-xs bg-green-600 text-white rounded-full">あなた</span>
                        )}
                      </div>
                    </div>
