        ...
        const dummySettingGroups: SettingGroup[] = [
          {
            ...
            items: [
              ...
              },
              {
                id: 'username',
                title: 'ユーザー名',
                description: 'LINEユーザー',
                type: 'info'
              },
              {
                id: 'email',
                title: 'メールアドレス',
                description: 'line@example.com',
                type: 'info'
              }
            ]
          },
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      {item.type === 'select' && (
                        <select
                          ...
                          className="bg-gray-700 text-white rounded px-3 py-1 focus:outline-none focus:ring-2 focus:ring-green-500"
                        >
                      ...
                      {item.type === 'button' && (
                        <button
                          onClick={item.action}
                          className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-300"
                        >
                          表示
                        </button>
                      )}
