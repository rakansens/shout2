        ...
        const dummyItems: StoreItem[] = [
          {
            id: '1',
            name: 'グリーンキャラクター',
            description: 'レアなグリーンキャラクター。特別な能力を持っています。',
            price: 500,
            image: 'https://placehold.co/300x300/green/white?text=Green+Character',
            category: 'character',
            isLimited: true
          },
          {
            id: '2',
            name: 'イエローキャラクター',
            description: '防御力が高いイエローキャラクター。',
            price: 400,
            image: 'https://placehold.co/300x300/yellow/black?text=Yellow+Character',
            category: 'character',
            isLimited: false
          },
          {
            id: '3',
            name: 'プラチナキャラクター',
            description: '希少なプラチナキャラクター。ポイント獲得量が増加します。',
            price: 800,
            image: 'https://placehold.co/300x300/silver/black?text=Platinum+Character',
            category: 'character',
            isLimited: true,
            isSoldOut: true
          },
          ...
          },
          {
            id: '6',
            name: 'ライトテーマ',
            description: 'アプリのテーマをライトモードに変更します。',
            price: 150,
            image: 'https://placehold.co/300x300/white/black?text=Light+Theme',
            category: 'theme',
            isLimited: false
          },
          {
            id: '7',
            name: 'フォレストテーマ',
            description: '自然をイメージしたフォレストテーマです。',
            price: 200,
            image: 'https://placehold.co/300x300/darkgreen/white?text=Forest+Theme',
            category: 'theme',
            isLimited: false
          },
          {
            id: '8',
            name: 'プレミアムパス',
            description: '30日間、プレミアム特典が利用できます。',
            price: 1000,
            image: 'https://placehold.co/300x300/gold/black?text=Premium+Pass',
            category: 'special',
            isLimited: true
          },
          {
          ...
          },
          {
            ...
            price: 350,
            image: 'https://placehold.co/300x300/green/white?text=Rare+Avatar',
            category: 'character',
            isLimited: true
          }
        ];
    ...
    <MainLayout>
      ...
      <div className="min-h-screen pb-20 pt-24">
        ...
        <div className="flex justify-end px-4 mb-4">
          <div className="bg-green-900/50 rounded-full px-4 py-2 flex items-center">
            <img
