      ...
      <div className="flex flex-col items-center gap-2.5 px-2 py-0 relative flex-1 self-stretch w-full overflow-y-auto">
        <div className="flex flex-col items-start px-4 py-[18px] pb-8 relative self-stretch w-full flex-[0_0_auto]">
         ...
         <div className="flex items-center justify-between relative self-stretch w-full flex-[0_0_auto] mt-4 mb-8">
            <Button 
              className="inline-flex items-center justify-center gap-[19px] px-11 py-3 relative flex-[0_0_auto] bg-[#00b1f1] rounded-[90px] overflow-hidden hover:bg-[#00b1f1]/90"
            ...
            <Button 
              className="inline-flex items-center justify-center gap-[19px] px-[63px] py-3 relative flex-[0_0_auto] bg-[#7030a0] rounded-[90px] overflow-hidden hover:bg-[#7030a0]/90"
