...
// Featured hero image data
const heroImage = {
  url: "https://c.animaapp.com/sVl5C9mT/img/hero-banner.png", // Placeholder URL, replace with actual image
  alt: "Featured Artist",
...
export function Home() {
  ...
  const { navigateWithAnimation, setIsHeaderHidden, setIsNavigationHidden } = useNavigationAnimation();
